			...
			<div class="row">
				...
				<div class="col-md-9 page-content col-thin-left">
					...
					<div class="category-list" style="    border: 0;">
					     ...
					     @auth
                    <div class="jobsearch-filter-responsive-wrap jobsearch-search-filter-wrap">
                        <!-- Date -->
                        <div class="list-filter">
                            <h5 class="list-title"><strong><a href="#"> Email me new jobs </a></strong></h5>
                            <div class="filter-date filter-content mt-2">
                                <form method="POST" action="" id="create-alert-form">
                                    {{ csrf_field() }}
                                    <div class="row mb-2">
                                        <?php $nameError = (isset($errors) and $errors->has('name')) ? ' is-invalid' : ''; ?>
                                        <div class="col-4">
                                            <input name="name" placeholder="Job alert name..." class="form-control {{ $nameError }}" maxlength="75" type="text" value="{{$alertName ?? ''}}">
                                        </div>
                                        <?php $emailError = (isset($errors) and $errors->has('email')) ? ' is-invalid' : ''; ?>
                                        <div class="col-4">                                                
                                            <input type="email" class="form-control {{ $emailError }}" placeholder="example@email.com" name="email" value="{{$alertEmail ?? ''}}">
                                        </div>
                                        <div class="col-4">
                                            <button id="create-alert-btn" class="btn btn-block btn-block-md btn-primary" type="submit">Create Alert</button>
                                        </div>
                                    </div>
                                    <div class="alert-frequency">
                                        <ul class="list-inline">
                                            <li class="list-inline-item"><input name="frequency" class="radio-frequency" maxlength="75" type="radio" value="Daily" checked="checked"> <label for="frequency14933237"><span></span>Daily</label></li>
                                            <li class="list-inline-item"><input name="frequency" class="radio-frequency" maxlength="75" type="radio" value="Weekly"> <label for="frequency85936349"><span></span>Weekly</label></li>
                                            <li class="list-inline-item"><input name="frequency" class="radio-frequency" maxlength="75" type="radio" value="Fortnightly"> <label for="frequency49176813"><span></span>Fortnightly</label></li>
                                            <li class="list-inline-item"><input name="frequency" class="radio-frequency" maxlength="75" type="radio" value="Monthly"> <label for="frequency72522789"><span></span>Monthly</label></li>
                                            <li class="list-inline-item"><input name="frequency" class="radio-frequency" maxlength="75" type="radio" value="Biannually"> <label for="frequency38369508"><span></span>Biannually</label></li>
                                            <li class="list-inline-item"><input name="frequency" class="radio-frequency" maxlength="75" type="radio" value="Annually"> <label for="frequency58374819"><span></span>Annually</label></li>
                                            <li class="list-inline-item"><input name="frequency" class="radio-frequency" maxlength="75" type="radio" value="Never"> <label for="frequency40390700"><span></span>Never</label></li>
                                        </ul>
                                    </div>
                                    <input type="hidden" name="url" id="current-url-input">
                                    @if(isset($cat))

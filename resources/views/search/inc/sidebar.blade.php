...
?>
<style>
    .list-filter.jobsearch-search-filter-wrap .filter-content{
        display:none;
    }
    .list-filter.jobsearch-search-filter-wrap.active .filter-content{
        display:block;
    }
    .list-filter.jobsearch-search-filter-wrap .list-title:before{
        display:none;
    }
    .list-filter.jobsearch-search-filter-wrap .list-title{
        border:none;
    }
    .list-filter.jobsearch-search-filter-wrap .list-title:after{
        display:none;
    }
    .list-filter.jobsearch-search-filter-wrap {
        padding-bottom:0px;
    }
    .list-title {
        margin-top: 5px;
...
<div class="col-md-3 page-sidebar mobile-filter-sidebar pb-4">
	<aside>
		<div class="inner-box enable-long-words " style="padding:0;">
			<!-- Date -->
			<div class="list-filter jobsearch-search-filter-wrap">
				<h5 class="list-title"><strong><a href="#"> {{ t('Date Posted') }} </a></strong><i class="fa fa-angle-down"></i></h5>
			...
			<!-- PostType -->
			<div class="list-filter jobsearch-search-filter-wrap">
				<h5 class="list-title"><strong><a href="#">{{ t('Job Type') }}</a><i class="fa fa-angle-down"></i></strong></h5>
			...
			<!-- Salary -->
			<div class="list-filter jobsearch-search-filter-wrap">
				<h5 class="list-title"><strong><a href="#">{{ t('Salary Pay Range') }}</a><i class="fa fa-angle-down"></i></strong></h5>
			...
			@if (isset($cat))
				...
				<!-- SubCategory -->
				<div id="subCatsList" class="categories-list list-filter jobsearch-search-filter-wrap">
					<h5 class="list-title">
						<strong><a href="#"><i class="fa fa-angle-left"></i> {{ t('Others Categories') }}</a><i class="fa fa-angle-down"></i></strong>
					</h5><div class="filter-content">
			...
			<!-- Category -->
			<div id="catsList" class="categories-list list-filter jobsearch-search-filter-wrap" <?php echo (isset($style)) ? $style : ''; ?>>
				<h5 class="list-title">
					<strong><a href="#">{{ t('All Categories') }}</a><i class="fa fa-angle-down"></i></strong>
				</h5><div class="filter-content">
				<ul class="list-unstyled">
			...
			<!-- City -->
			<div class="locations-list list-filter jobsearch-search-filter-wrap">
				<h5 class="list-title"><strong><a href="#">{{ t('Location') }}</a><i class="fa fa-angle-down"></i></strong></h5>

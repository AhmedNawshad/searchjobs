                                        ...
                                        foreach ($reviews as $key => $review):
                                            ...
                                            <tr>
                                                <td class="add-img-selector">
                                                    <div class="checkbox">
                                                        <label><input type="checkbox" name="entries[]" value="{{ $review->id }}"></label>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div style="word-break:break-all;">
                                                        ...
                                                        <br>
                                                        <strong>Reviewed by:</strong>&nbsp;{{ $review->reviewer->name }}<br>
                                                ...
                                                <td class="action-td">
                                                    <div>
                                                        <p>
                                                            <a class="btn btn-default btn-sm" href="{{ lurl('search-talent/seeker/' . $review->user_id) }}">

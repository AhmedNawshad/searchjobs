                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="word-break:break-all;">
                                                ...
                                                <br>
                                                <strong>{{ t('Name') }}:</strong>&nbsp;{{ \App\Models\User::find($applicant->appl_id)->name }}<br>
                                                <strong>{{ t('Email') }}:</strong>&nbsp;{{ \App\Models\User::find($applicant->appl_id)->email }}<br>
                                            ...
                                            <div>
                                                <p>
                                                    <a class="btn btn-default btn-sm"
                                                       onclick="document.location='https://searchjobs.global/search-talent/seeker/2'">

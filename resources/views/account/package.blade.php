                            ...
                            <table id="addManageTable"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:88%" data-sort-ignore="true">{{ ('Package Details') }}</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="word-break:break-all;">
                                                <strong>{{ 'Connects' }}:</strong>&nbsp;{{ 10 }}<br>

                                                <strong>{{ 'Package Name' }}:</strong>&nbsp;{{ $applicant->name }}<br>
                                                <strong>{{ 'Price' }}:</strong>&nbsp;{{ $applicant->price }}<br>
                                            ...
                                            <div>
                                                <p>
                                                    <a class="btn btn-default btn-sm"
                                                        href="{{ lurl('account/conversations/' . $applicant->id . '/messages') }}">

                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div style="word-break:break-all;">                                                        
                                                        ...
                                                        <strong>{{ t('Email') }}:</strong>&nbsp;{{ $company->company->email }}:<br>
                                                        <strong>{{ t('Phone') }}:</strong>&nbsp;{{ $company->company->phone }}:<br>
                                                    </div>
                                                </td>
                                                <td class="action-td">
                                                    <div>
                                                        <p>
                                                            <a class="btn btn-default btn-sm" href="{{ lurl('companies/' . $company->company->id . '/jobs') }}">

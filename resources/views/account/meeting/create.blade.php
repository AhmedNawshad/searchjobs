		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-9 page-content">
					...
					<div class="inner-box">
						<h2 class="title-2"><i class="icon-town-hall"></i> Create Meeting </h2>
						
						<div class="mb30" style="float: right; padding-right: 5px;">
							<a href="{{ lurl('account/meetings') }}">Meetings list</a>
						</div>
						...
						<div class="panel-group" id="accordion">
							...
							<div class="card card-default">
								<div class="card-header">
									<h4 class="card-title"><a href="#companyPanel" data-toggle="collapse" data-parent="#accordion"> Meeting Informations </a></h4>
								</div>
								<div class="panel-collapse collapse show" id="companyPanel">
									<div class="card-body">
										<form name="meeting" class="form-horizontal" role="form" method="POST" action="{{ lurl('account/meetings') }}">
											{!! csrf_field() !!}

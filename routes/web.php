...
Route::get('mailx',function() {
    ...
    print_r('ccc');
    exit;
    // mail("jackshanan2017@gmail.com","test","testtt");
 });
...
Route::group([
    ...
    Route::group(['middleware' => ['web', ]], function ($router) {
        ...
        Route::group(['middleware' => ['auth', 'banned.user', 'prevent.back.history'], 'namespace' => 'Account'], function ($router) {
             ...
             */
            $router->pattern('pagePath', '(my-posts|archived|favourite|pending-approval|saved-search|followers|interviews|reviews|company-followers)+');
            ...
            Route::get('account/save-candidates', 'SaveCandidateController@index')->name('save.candidate.list');
            Route::get('account/save-candidates/delete/{save_candidates_delete}', 'SaveCandidateController@destroy')->name('save.candidate.destroy');
        });
